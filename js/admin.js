            ...
            container.innerHTML = snapshot.docs.map(doc => {
                ...
                return `
                    <div class="admin-tool-item">
                        ...
                        <div class="actions">
                            <button class="btn-edit" onclick="startEdit('${doc.id}')" style="margin-right:0.5rem; background:#3b82f620; color:#3b82f6; border:1px solid #3b82f640; padding:0.5rem; border-radius:6px; cursor:pointer;">
                                <i class="fa-solid fa-pen"></i>
                            </button>
                            <button class="btn-delete" onclick="deleteTool('${doc.id}')">
